...
public interface Task1Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Task1Parser#binOp}.
	 * @param ctx the parse tree
	 */
	void enterBinOp(Task1Parser.BinOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link Task1Parser#binOp}.
	 * @param ctx the parse tree
	 */
	void exitBinOp(Task1Parser.BinOpContext ctx);
	/**
	 * Enter a parse tree produced by {@link Task1Parser#unOp}.
	 * @param ctx the parse tree
	 */
	void enterUnOp(Task1Parser.UnOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link Task1Parser#unOp}.
	 * @param ctx the parse tree
	 */
	void exitUnOp(Task1Parser.UnOpContext ctx);
	/**
